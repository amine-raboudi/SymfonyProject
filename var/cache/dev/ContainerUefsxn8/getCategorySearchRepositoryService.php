 ...
 */
class getCategorySearchRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategorySearchRepository' shared autowired service.
     *
     * @return \App\Repository\CategorySearchRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategorySearchRepository.php';

        return $container->privates['App\\Repository\\CategorySearchRepository'] = new \App\Repository\CategorySearchRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

...
class getPropertySearchRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PropertySearchRepository.php';

        return $container->privates['App\\Repository\\PropertySearchRepository'] = new \App\Repository\PropertySearchRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

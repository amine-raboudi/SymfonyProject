...
class __TwigTemplate_b91c31949fd8fadb21dea8ff934809a73df1660dad65ff1ff9f2ed1a0e5e64ce extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "
<div class=\"row\">
    <div class=\"form-row align-items-end\" xmlns=\"http://www.w3.org/1999/html\">
        <div class=\"col\">
            <h3>Nom</h3>
            <p class=\"\">  ";
        // line 10
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "nom", [], "any", false, false, false, 10), 'form');
        echo "</p>
        </div>
        <div class=\"col\">
        ...
        if ((isset($context["articles"]) || array_key_exists("articles", $context) ? $context["articles"] : (function () { throw new RuntimeError('Variable "articles" does not exist.', 21, $this->source); })())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
                ...
                echo "</td>
                    <td>";
                // line 36
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "category", [], "any", false, false, false, 36), "html", null, true);
                echo "</td>
...
";
    ...
    {
        return array (  162 => 45,  158 => 43,  153 => 40,  143 => 36,  139 => 35,  135 => 34,  132 => 33,  128 => 32,  116 => 22,  114 => 21,  108 => 18,  97 => 10,  88 => 5,  78 => 4,  59 => 2,  36 => 1,);
    }
...
{% endblock %}
", "articles/index.html.twig", "C:\\xampp\\htdocs\\symfony-project-master\\templates\\articles\\index.html.twig");
    }
}
